...
- **Sound** — still the biggest feel-per-effort upgrade available, and still absent.
  M7 § 6 restates the cost: a new asset class, a new budget line, and new offline
  precache surface. One word and it becomes a milestone.
